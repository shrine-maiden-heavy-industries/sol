...
class SolECP5DomainGenerator(SolDomainGenerator):
	...
	def create_submodules(self, m, platform):
		...
		if clock_frequency not in pll_params_per_freq:
			raise ValueError(f'Unsupported clock frequency {clock_frequency}')

		pll_params = pll_params_per_freq[clock_frequency]
