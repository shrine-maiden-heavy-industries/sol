...
class USBAnalyzerOverflowTest(SolGatewareTestCase):
	...
	fast_traffic: tuple[tuple[int, ...] | WaitDict, ...] = (
		...
		(
			0x4b, 0x12, 0x03, 0x42, 0x00, 0x45, 0x00, 0x35, 0x00, 0x39, 0x00, 0x30, 0x00,
			0x46, 0x00, 0x35, 0x00, 0xfd, 0xc3
		),
		# ACK
		(0xd2,),
		...
		(0x69, 0x4a, 0x80),
		# DATA1 [
		# 	34 03 64 00 72 00 61 00 67 00 6f 00 6e 00 42 00 6f 00 6f 00 74 00 20 00 44 00
		# 	46 00 2a 00 10 00 31 00 37 00 37 00 3a 00 36 00 37 00 30 00 32 00 32 00 39 00
		# ]
		(
		...
		# DATA1 [ 12 03 42 00 46 00 43 00 35 00 39 00 30 00 46 00 35 00 ]
		(
			0x4b, 0x12, 0x03, 0x42, 0x00, 0x46, 0x00, 0x43, 0x00, 0x35, 0x00,
			0x39, 0x00, 0x30, 0x00, 0x46, 0x00, 0x35, 0x00, 0xcc, 0x2d
		),
		# ACK
		(0xd2,),
		...
		(0x69, 0x4a, 0x80),
		# DATA1 [
		# 	44 03 44 00 65 00 76 00 69 00 63 00 65 00 20 00 46 00 69 00 72 00 6d 00 77 00 61 00 72 00 65 00
		# 	20 00 55 00 70 00 67 00 72 00 30 00 32 00 32 00 10 00 34 00 37 00 3a 00 32 00 39 00 33 00 30 00
		# ]
		(
